...
export const Nav = () => {
	...
	return (
		<div className="
			fixed z-30 left-0 right-0 bottom-8 mx-auto h-fit max-w-96 w-fit
			sm:left-0
		...
		">
			<div className={`flex flex-col ${hasNotif && 'bg-theme1'} rounded-t-2xl rounded-xl h-fit shadow-[0px_4px_8px_1px_rgba(0,_0,_0,_0.65)]`}>
				<div className="flex flex-row items-center px-6 py-2 w-fit h-fit gap-4 bg-material-neutral-secondary rounded-xl">
					...
					<a className="flex self-center" href="https://www.linkedin.com/in/jeffreymostyn/">
